...
RUN \
  ...
  apt-get update && \
  apt-get install -y --no-install-recommends wget jq python3-gi gir1.2-gtk-3.0 gir1.2-rsvg-2.0 librsvg2-common gir1.2-gtksource-4 python3-cairo python3-gi-cairo xfce4-terminal && \
